    ...
    <div class="main-content">
      ...
      <div class="sidebar">
        <nav class="sidebar-nav">
          ...
          <router-link to="/lecturer/manage-enrollment" class="nav-item" active-class="active">
            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <router-link to="/lecturer/enter-final-marks" class="nav-item" active-class="active">
            ...
            <span class="nav-label">Final Exam</span>
          </router-link>
          ...
          <div class="nav-section">
            ...
            <router-link to="/lecturer/bulk-upload" class="nav-item" active-class="active">
              <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
              </svg>
              <span class="nav-label">CSV Upload</span>
            </router-link>

            <router-link to="/lecturer/export-csv" class="nav-item" active-class="active">
              <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
              </svg>
              <span class="nav-label">CSV Export</span>
            </router-link>
          </div>
